...
//
//public abstract class BaseDataRepository<T extends Base> extends AbstractDataService<T> {
//
//	@Autowired @Lazy
...
//		return jdbcTemplate.query(q, getResultSetExtractor());
//		return jdbcTemplate.
//	}
//
...
//	}
//
//	protected ResultSetExtractor<T> getResultSetExtractor() {
